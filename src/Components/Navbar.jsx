    ...
    <div>
      ...
      <nav className="bg-dark3 shadow-md flex items-center justify-between fixed top-0 w-full z-50 p-5">
        ...
        <ul
          className={`${
            nav ? "left-0" : "-left-full"
          } md:static absolute md:mx-8 top-0 md:top-12 md:flex md:items-center bg-dark3 md:bg-transparent w-[75%] md:w-auto h-screen md:h-auto p-5 md:p-0 transition-all duration-500 ease-in-out md:ml-auto`}
        >
          {/* Show Title above nav links on mobile */}
          <div className="md:hidden mb-6 flex items-center">
            <IoCodeSlashSharp size={30} className="text-white mr-2" />
            <span className="text-white font-galada text-2xl">
              Iconic Vision
            </span>
          </div>

          <li className="text-white text-xl p-2 border-b border-gray-600 md:border-none">
            <Link to="/" onClick={() => setNav(false)}>
              Home
            </Link>
          </li>
          <li className="text-white mt-5 md:mt-0 text-xl p-2 border-b border-gray-600 md:border-none">
            <Link to="/about" onClick={() => setNav(false)}>
              About
            </Link>
          </li>
          ...
          <li className="text-white mt-5 md:mt-0 text-xl p-2 border-gray-600 md:border-none">
            <Link to="/contact" onClick={() => setNav(false)}>
              Contact
            </Link>
          </li>
